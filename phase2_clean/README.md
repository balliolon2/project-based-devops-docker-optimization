...
* **สถานการณ์:** แก้โค้ด `app.py` บ่อยมาก แต่ `requirements.txt` นานๆ แก้ที
* **ผลลัพธ์:**
...
ถ้าบอนด์เขียน `COPY . .` ไว้บรรทัดบนสุด Docker จะมองว่า "ไฟล์เปลี่ยนแล้ว" และจะสั่ง `pip install` ใหม่ **ทุกครั้ง** ที่แก้โค้ดแม้แต่ตัวอักษรเดียวครับ (นรกของการรอคอย)
